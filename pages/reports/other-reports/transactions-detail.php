...
<div class="card pb-4" id="cardData">
  <div class="card-header d-flex flex-wrap align-items-start justify-content-between gap-3">
    ...
    <div id="periodBox" class="d-flex align-items-center gap-2">
      <i class="icon-base ti tabler-calendar-event icon-lg text-primary"></i>
      <div>
        <div class="small text-secondary fw-medium">Period</div>
        <div class="fw-semibold" id="range"></div>
      </div>
    </div>
  </div>
