  ...
  <div class="col-md">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb breadcrumb-custom-icon">
        ...
        <li class="breadcrumb-item active">Partner Report</li>
      </ol>
    </nav>
  </div>
...
<div class="card pb-4" id="cardData">
  <div class="card-header">
    ...
    <p class="h2 text-center mb-0 dm-serif-text-regular text-primary">Partner Report</p>
    <p class="h5 text-center text-secondary spectral mb-1">Laporan data partner/guide</p>
  ...
  <div class="card-footer pt-4">
    <p class="h5 px-3">Total Records : <span id="totalPartner"></span></p>
  </div>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="judulFilter">Partner Report</h5>
        <button
          type="button"
          class="btn-close"
...
<script src="js/reports/masda-reports/partner-report.js" type="text/javascript"></script>
