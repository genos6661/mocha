  ...
  <div class="col-md">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb breadcrumb-custom-icon">
        ...
        <li class="breadcrumb-item active">Summary Valas</li>
      </ol>
    </nav>
  </div>
  ...
  <div class="card-body p-0 table-responsive">
    <table class="table table-bordered">
      <thead class="table-dark">
        <tr>
          <th class="text-center align-middle p-2" rowspan="2" style="width: 8%; border: 1px solid;">Forex Code</th>
          <th class="text-center align-middle p-2" rowspan="2" style="width: 20%; border: 1px solid;">Forex Name</th>
          <th class="text-center align-middle p-2" rowspan="2" style="width: 11%; border: 1px solid;">Beginning Balance</th>
          <th class="text-center" colspan="2">Mutation</th>
          <th class="text-center align-middle p-2" rowspan="2" style="width: 11%; border: 1px solid;">Ending Balance</th>
          <th class="text-center" colspan="2">Mutation (IDR)</th>
        </tr>
        <tr>
          <th class="text-center" style="width: 10%; border: 1px solid;">Buy</th>
          <th class="text-center" style="width: 10%; border: 1px solid;">Sell</th>
          <th class="text-center" style="width: 15%; border: 1px solid;">Buy</th>
          <th class="text-center" style="width: 15%; border: 1px solid;">Sell</th>
        </tr>
      </thead>
    </table>
  </div>
...
<div class="card pb-4" id="cardData">
  <div class="card-header border-bottom">
    ...
    <p class="h2 text-center mb-1 dm-serif-text-regular text-primary">Summary Valas</p>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="judulFilter">Summary Valas</h5>
        <button
          type="button"
          class="btn-close"
