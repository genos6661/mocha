        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.tanggal_lahir) {
                    ...
                    tanggal = tgl.toLocaleDateString('en-ID', options);
                }
                ...
                $('#tempat_lahirDetail').text(data.tempat_lahir);
                $('#tanggal_lahirDetail').text(tanggal || null);
...
modalEdit.addEventListener('shown.bs.modal', event => {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#tempat_lahirEdit').val(response.tempat_lahir);
            $('#tanggal_lahirEdit').val(formatted);
...
$('#sbmEdit').click(async function (e) {
    ...
    const formData = {
        ...
        tempat_lahir: $('#tempat_lahirEdit').val(),
        tanggal_lahir: $('#tanggal_lahirEdit').val(),
